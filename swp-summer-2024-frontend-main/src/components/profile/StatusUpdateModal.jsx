...
export default function StatusUpdateModal({
  ...
  return (
    ...
    >
      ...
      <p className="text-[0.8em] text-red-500 italic py-2 font-montserrat">
        Once you have confirmed, this action CANNOT be reverted and this product
        is NEVER going to be able to be sold within our system again.
      </p>

      <p className="text-[0.8em] text-sky-600 italic pb-2 font-montserrat">
