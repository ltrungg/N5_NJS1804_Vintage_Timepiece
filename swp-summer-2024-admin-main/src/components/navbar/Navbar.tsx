...
export default function Navbar() {
  ...
  return (
    <div className="w-screen min-h-20 max-h-20 flex flex-row bg-teal-950 text-white justify-between items-center px-4 py-2">
      <div className="flex items-center gap-4 py-2">
        ...
        <p className="font-semibold text-[1.5em]">
